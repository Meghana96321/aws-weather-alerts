# 🌦 AWS Real-time Weather Notification System

This project fetches **real-time weather updates** using the OpenWeatherMap API and sends alerts via **AWS SNS (SMS/Email)**. It runs on **AWS Lambda**, is triggered by **CloudWatch**, and operates without managing any servers!
